...
namespace linq
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            IEnumerable<int> asc = from num in numbers2
            ...
            double purchSum = purchases.Sum();

            // Console.WriteLine(purchSum);
            ...
            */
            ...
            List<int> squaredo = wheresSquaredo.TakeWhile(n => Math.Sqrt(n) % 1 != 0).ToList();
